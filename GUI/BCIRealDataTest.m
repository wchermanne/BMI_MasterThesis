...
for side = 1:1:3 
    ...
    for i = 1:1:20
        ...
        load(['/Users/matthieu/GitHub/BMI_MasterThesis/GUI/RealDataRobin904/09_04_18_' text_side  num2str(i) '.mat']);
        C3 = downsample(C3,2);
        C4 = downsample(C4,2);
        Cz = downsample(Cz,2);
...
%             Cz_filtered = filter(b_fir_mu,1,Cz_filtered);
            ...
            W_Csp = CSP_training_Real_Data_Downsampling(b_fir_mu);
...
TrainingSetTarget = zeros(60,3);
TrainingSetTarget(1:20,3) = ones(20,1);
TrainingSetTarget(21:40,2) = ones(20,1);
TrainingSetTarget(41:60,1) = ones(20,1);
close all
