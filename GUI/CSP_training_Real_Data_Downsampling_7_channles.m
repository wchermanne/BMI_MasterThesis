function [W_Csp] = CSP_training_Real_Data_Downsampling_7_channles(b,a)
...
R_ave_right = zeros(5,5);
for k = 1:1:60
    load(['/Users/matthieu/GitHub/BMI_MasterThesis/GUI/2504Data/25_04_18_Right'  num2str(k) '.mat']);
%     C3 = downsample(C3,2);
%     C4 = downsample(C4,2);
%     Cz = downsample(Cz,2);
...
R_ave_right = R_ave_right./60;

R_ave_left = zeros(5,5);
for k = 1:1:60
    load(['/Users/matthieu/GitHub/BMI_MasterThesis/GUI/2504Data/25_04_18_Left'  num2str(k) '.mat']);
%     C3 = downsample(C3,2);
%     C4 = downsample(C4,2);
%     Cz = downsample(Cz,2);
%     CP1 = downsample(CP1,2);
